...
# CORS CONFIGURATION
# -----------------------------------------------------------------------------
CORS_ALLOW_ALL_ORIGINS = True  # Set to True for development to solve React issues
CORS_ALLOW_CREDENTIALS = True

# -----------------------------------------------------------------------------
# EMAIL CONFIGURATION (FIXED FOR WINERROR 10060)
# -----------------------------------------------------------------------------

# Use Console during development if you are offline, otherwise use SMTP
# If you want to FORCE send emails even in dev, just leave it as SMTP
...
# CRITICAL: If the connection takes longer than 10 seconds, stop trying. 
# This prevents the 10060 error from freezing your React app.
EMAIL_TIMEOUT = 10